...
class FuelsControllerTest < ActionController::TestCase
  ...
  test "should create fuel" do
    assert_difference('Fuel.count') do
      post :create, fuel: { calorie: @fuel.calorie, date: @fuel.date, food: @fuel.food, meal_type: @fuel.meal_type }
    end
  ...
  test "should update fuel" do
    patch :update, id: @fuel, fuel: { calorie: @fuel.calorie, date: @fuel.date, food: @fuel.food, meal_type: @fuel.meal_type }
    assert_redirected_to fuel_path(assigns(:fuel))
  end
